...
def display_title_screen():
    title = "Holt and Simple Exponential Smoothing and Trend Analysis"
    author = "Author: C. van der Kaay"
    options = (
    ...
    print(INFO_FG + "\nProgram Summary:")
    print("This program performs advanced time series analysis using Holt Exponential Smoothing and")
...
def view_full_rundown():
    ...
    print("4. Holt Exponential Smoothing model fitting and forecasting")
    print("5. Simple Exponential Smoothing model fitting and forecasting")
    print("6. Residual analysis including Ljung-Box, Shapiro-Wilk, and Kolmogorov-Smirnov tests")
    print("7. Heteroscedasticity tests: Breusch-Pagan, White, and Spearman's rank correlation")
    print("8. Plotting of data, residuals, and Autocorrelation Function (ACF)")
    print("9. Spectral and decomposition analysis")
...
def perform_full_analysis(data, debug=False):
    ...
    if not mk_result[0] and cox_stuart_p >= 0.05 and adf_p >= 0.05:
        print(WARNING_FG + "Warning: No trend or stationarity detected. This test may not be "
    ...
    while True:
        ...
        print("1. Holt Exponential Smoothing")
        print("2. Simple Exponential Smoothing")

        method_choice = input(PROMPT_FG + "Enter your choice (1 or 2): ").strip()
